...
export const allBlogPosts = [
  ...
  },
  {
    ...
    excerpt: 'Halo teman-teman! Untuk menutup tahun ini openSUSE Indonesia ingin mengadakan meetup terakhir tahun 2022. Skuy langsung gas join bareng kita 🔥🔥🔥 https://s.id/osidmeetupdesember',
  ...
  },
  {
    ...
    excerpt: 'Apa itu ILC? Yang jelas bukan Indonesia Lawyers Club. ILC adalah Indonesia Linux Conference yang di tahun 2022 ini rencananya akan dilaksanakan di Ponorogo, namun karena satu dan lain hal berpindah ke Sidoarjo tepatnya di Universitas Muhammadiyah Sidoarjo. Tentang sejarah ILC sendiri, penulis men...',
  ...
  {
    id: 4,
    title: 'openSUSE-ID Meet Up',
    excerpt: 'Halo teman-teman. openSUSE Indonesia ingin mengadakan meetup offline nih di awal bulan Oktober. Sabtu, 1 Oktober 2022 Indigo Space Jakarta 12.00-17.00 WIB Segera daftar yuk! ada beberapa hadiah menarik daftar di http://s.id/openSUSEIDMeetup Kuota terbatas ya!',
    image: 'https://opensuse.id/wp-content/uploads/2022/09/poster-feed.png',
    category: 'kegiatan',
    date: '9 September 2022',
    slug: 'opensuse-id-meet-up'
  },
  {
    id: 5,
    title: 'Pendaftaran Peserta ILC 2022 Dibuka',
    ...
    slug: 'pendaftaran-peserta-ilc-2022-dibuka'
  },
  {
    id: 6,
    title: '15 Tahun openSUSE-ID',
    excerpt: 'Hari ini, Sabtu 23 Juli 2022, Komunitas openSUSE Indonesia merayakan ulang tahun yang ke 15. Berikut ini tangkapan layar mengenai sejarah pembentukan Komunitas openSUSE Indonesia yang sempat diambil cuplikan layarnya dari halaman http://wiki.opensuse-id.org:80/index.php?title=Sejarah_Komunitas_op...',
    image: 'https://opensuse.id/wp-content/uploads/2022/07/openSUSE-ID-15-aniv.png',
    category: 'komunitas',
    date: '23 Juli 2022',
    slug: '15-tahun-opensuse-id'
  },
  {
    id: 7,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2022/02/photo_2022-02-11_15-13-07-1232x924.jpg',
    category: 'panduan',
    date: '11 Februari 2022',
    slug: 'memperbaiki-function-key-keyboard-keychron-k2-di-opensuse-tumbleweed'
  },
  {
    id: 8,
    title: 'Are You Ready for Kubernetes Community Days Indonesia 2021?',
    excerpt: 'Register now and check out the agenda at http://kubernetesdays.id! Komunitas openSUSE Indonesia merupakan mitra komunitas Kubernetes Community Days Indonesia 2021',
    image: 'https://opensuse.id/wp-content/uploads/2021/10/KCD2021-Regist-3-1232x767.png',
    category: 'kegiatan',
    date: '30 Oktober 2021',
    slug: 'are-you-ready-for-kubernetes-community-days-indonesia-2021'
  },
  {
    id: 9,
    title: 'Call For Papers Kubernetes Community Days Indonesia 2021',
    excerpt: 'Call For Papers Kubernetes Community Days Indonesia 2021 dibuka mulai 6 Agustus 2021-15 September 2021 Pengumuman CFP 8 Oktober 2021 Info lebih lanjut https://community.cncf.io/events/details/cncf-kcd-indonesia-presents-kubernetes-community-days-indonesia-2021/ Komunitas openSUSE Indonesia merupa...',
    image: 'https://opensuse.id/wp-content/uploads/2021/08/KCD2021-CFPv1-1232x747.png',
    category: 'kegiatan',
    date: '11 Agustus 2021',
    slug: 'call-for-papers-kubernetes-community-days-indonesia-2021'
  },
  {
    id: 10,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2021/08/Screenshot-from-2021-08-02-09-50-10-1232x693.png',
    category: 'panduan',
    date: '2 Agustus 2021',
    slug: 'memasang-gnome-wireless-display-miracast-dengan-flatpak-di-opensuse-leap-15-3'
  },
  {
    id: 11,
    title: 'Cangkrukan Daring Bersama KLAS, openSUSE-ID dan IOID',
    excerpt: '[CANGKRU’AN DARING] Halo semua, kali ini KLAS akan ada cangkru’an secara virtual untuk lebih mengenal terkait dengan openSUSE.Asia Virtual Summit 2021 dan Indonesia OpenInfra Days 2021. Yuk jangan lupa catat jadwalnya: Hari/Tanggal: 16 Juli 2021 Pukul: 19.00 WIB Pemateri 1: Muhammad Luthfi As Sya...',
    image: 'https://opensuse.id/wp-content/uploads/2021/07/photo_2021-07-14_17-45-51.jpg',
    category: 'kegiatan',
    date: '14 Juli 2021',
    slug: 'cangkrukan-daring-bersama-klas-opensuse-id-dan-ioid'
  },
  {
    id: 12,
    title: 'Pendaftaran Peserta Indonesia OpenInfra Days 2021',
    excerpt: 'Tautan pendaftaran: https://s.id/ioid21_register Info lebih lanjut: https://openstack.id/ioid21/ Komunitas openSUSE Indonesia merupakan mitra komunitas Indonesia OpenInfra Days 2021',
    image: 'https://opensuse.id/wp-content/uploads/2021/07/photo_2021-07-06_12-20-16-1232x1163.jpg',
    category: 'kegiatan',
    date: '9 Juli 2021',
    slug: 'pendaftaran-peserta-indonesia-openinfra-days-2021'
  },
  {
    id: 13,
    title: 'Call For Paper openSUSE.Asia Summit 2021',
    ...
    category: 'kegiatan',
    date: '4 Juli 2021',
    slug: 'call-for-paper-opensuse-asia-summit-2021'
  },
  {
    id: 14,
    title: 'Undangan Penyajian Indonesia OpenInfra Days 2021',
    excerpt: 'Indonesia OpenInfra Days 2021 akan kembali diadakan pada hari Sabtu, 21 Agustus 2021 secara virtual melalui Kanal Resmi Youtube OpenStack Indonesia. Acara ini akan menyajikan Sesi Kilat (Lightning Talks) dan Sesi Penyajian (Talks). Panitia mengundang Anda untuk berpartisipasi menjadi penyaji dala...',
    image: 'https://opensuse.id/wp-content/uploads/2021/06/IOID2021v6-2-1232x1025.png',
    category: 'kegiatan',
    date: '3 Juli 2021',
    slug: 'undangan-penyajian-indonesia-openinfra-days-2021'
  },
  {
    id: 15,
    title: 'Kompetisi Logo openSUSE.Asia Summit 2021 Dibuka',
    excerpt: 'Halo semua, setelah di tahun 2020 sempat terhenti karena pandemi Covid-19, openSUSE.Asia Summit kembali lagi nih di tahun 2021. Rasanya openSUSE.Asia Summit itu tidak lengkap tanpa kompetisi/lomba/kontes logo. Kompetisi logo openSUSE.Asia Summit 2021 sudah dibuka lho. Yuk pada ikutan. Pemenang ak...',
    image: 'https://opensuse.id/wp-content/uploads/2021/06/Logo-call.png',
    category: 'kegiatan',
    date: '5 Juni 2021',
    slug: 'kompetisi-logo-opensuse-asia-summit-2021-dibuka'
  },
  {
    id: 16,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2021/05/191959767_10158573279002284_7600376146720937307_n-1232x616.png',
    category: 'uncategorized',
    date: '2 Juni 2021',
    slug: 'opensuse-leap-15-3-menjembatani-jalan-menuju-enterprise'
  },
  {
    id: 17,
    title: 'Pesan untuk Komunitas openSUSE',
    excerpt: 'Halo teman-teman komunitas, openSUSE telah dikenal selama bertahun-tahun sebagai komunitas yang luar biasa, besar, dan ramai. Tetapi setelah banyak diskusi dengan banyak kelompok linguistik yang menyusun mozaik openSUSE, kami merasa masih banyak yang bisa dilakukan untuk memfasilitasi komunikasi ...',
    image: 'https://opensuse.id/wp-content/uploads/2021/03/hackweek.png',
    category: 'komunitas',
    date: '10 Maret 2021',
    slug: 'pesan-untuk-komunitas-opensuse'
  },
  {
    id: 18,
    title: 'Menambahkan Repositori ISO',
    excerpt: 'Kita butuh memasang ISO sebagai repositori pada saat: Melakukan instalasi menggunakan Flashdisk/USB Flash Drive yang dibuat bootable menggunakan Ventoy. Karena dengan cara ini, installer masih berupa file ISO. Dan tidak seperti instalasi yang dilakukan dengan piringan DVD yang bisa langsung digun...',
    image: 'https://opensuse.id/wp-content/uploads/2021/02/yast-software.png',
    category: 'panduan',
    date: '3 Februari 2021',
    slug: 'menambahkan-repositori-iso'
  },
  {
    id: 19,
    title: 'Pemenang Survei openSUSE Indonesia Tahun 2020',
    excerpt: 'Terima kasih sebelumnya kami ucapkan sudah berkenan untuk mengisi survei Tahun ini, semoga saran dan masukan dari teman-teman semuanya bisa membuat komunitas openSUSE Indonesia bisa lebih baik lagi. Kami ucapkan juga selamat kepada 5 pemenang terpilih acak yang beruntung mendapatkan T-Shirt dan M...',
    image: 'https://opensuse.id/wp-content/uploads/2020/12/Button-filled-colour.png',
    category: 'komunitas',
    date: '2 Januari 2021',
    slug: 'pemenang-survei-opensuse-indonesia-tahun-2020'
  },
  {
    id: 20,
    title: 'Survei openSUSE Indonesia Tahun 2020',
    excerpt: 'Halo teman-teman semua 🎉🎉 Dapatkan T-Shirt dan Majalah spesial edition GRATIS dengan cara mengisi Survei openSUSE Indonesia Tahun 2020 untuk 5 orang yang beruntung, pemenang akan diundi tanggal 2 Januari 2021 s.id/survei-osid20 Semoga beruntung! Selain itu ada juga openSUSE 2020 End of Year Surve...',
    image: 'https://opensuse.id/wp-content/uploads/2020/12/Button-filled-colour.png',
    category: 'komunitas',
    date: '19 Desember 2020',
    slug: 'survei-opensuse-indonesia-tahun-2020'
  },
  {
    id: 21,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/12/social-card.png',
    category: 'panduan',
    date: '4 Desember 2020',
    slug: 'memasang-github-cli-pada-opensuse'
  },
  {
    id: 22,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/10/Cuplikan-layar-dari-2020-10-21-13-46-25-1232x693.png',
    category: 'panduan',
    date: '21 Oktober 2020',
    slug: 'mencoba-microsoft-edge-dev-pada-opensuse-leap'
  },
  {
    id: 23,
    title: 'Pendaftaran Open Infrastructure & Cloud Native Day Indonesia 2020',
    excerpt: 'Info lebih lanjut mengenai poster dapat diakses pada tautan: https://s.id/oi_cnd2020info Agenda acara dapat diakses disini.',
    image: 'https://opensuse.id/wp-content/uploads/2020/10/register-oicndi20-16102023.jpg',
    category: 'kegiatan',
    date: '19 Oktober 2020',
    slug: 'pendaftaran-open-infrastructure-cloud-native-day-indonesia-2020'
  },
  {
    id: 24,
    title: 'openSUSE + LibreOffice Virtual Conference',
    excerpt: 'openSUSE dan LibreOffice menggabungkan konferensi tahunannya pada tahun 2020. Konferensi bersama ini digabungkan untuk merayakan 10 tahun Proyek LibreOffice dan 15 tahun Proyek openSUSE. Acara semula akan diselenggarakan di Nuremberg, Jerman. Namun karena situasi pandemi, acara bergeser menjadi s...',
    image: 'https://opensuse.id/wp-content/uploads/2020/10/winner.png',
    category: 'kegiatan',
    date: '10 Oktober 2020',
    slug: 'opensuse-libreoffice-virtual-conference'
  },
  {
    id: 25,
    title: 'Call for Presentation Open Infrastructure & Cloud Native Days 2020',
    excerpt: 'Info lebih lanjut https://s.id/oi_cnd2020cfpinfo',
    image: 'https://opensuse.id/wp-content/uploads/2020/10/cfp-update-06102020-id-1.jpg',
    category: 'kegiatan',
    date: '6 Oktober 2020',
    slug: 'call-for-presentation-open-infrastructure-cloud-native-days-2020'
  },
  {
    id: 26,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/09/code.png',
    category: 'panduan',
    date: '25 September 2020',
    slug: 'memasang-vscodium-di-opensuse'
  },
  {
    id: 27,
    title: 'Minimal/custom install KDE',
    excerpt: 'Setelah selesai melakukan minimal/custom install openSUSE dan membuat fitur factory reset, langkah selanjutnya adalah memasang Desktop Environment/Window Manager, Display Manager, aplikasi-aplikasi pendukung dan modul-modul YaST yang diperlukan. Tapi sayangnya saya cuma punya satu laptop, sehingg...',
    image: 'https://opensuse.id/wp-content/uploads/2020/08/kde-minimal.png',
    category: 'panduan',
    date: '7 September 2020',
    slug: 'minimal-custom-install-kde'
  },
  {
    id: 28,
    title: 'Mencoba Destop Pantheon pada openSUSE Tumbleweed',
    excerpt: 'Pasang openSUSE Tumbleweed Tambahkan repo Pantheon sudo zypper https://download.opensuse.org/repositories/X11:/Pantheon:/Branch/openSUSE_Tumbleweed/ X11:Pantheon Segarkan sudo zypper ref Pasang pola Pantheon sudo zypper in -t pattern pantheon Have Fun!',
    image: 'https://opensuse.id/wp-content/uploads/2020/09/pantheon-tumbleweed-1232x770.png',
    category: 'panduan',
    date: '5 September 2020',
    slug: 'mencoba-destop-pantheon-pada-opensuse-tumbleweed'
  },
  {
    id: 29,
    title: 'Membuat fitur factory reset',
    excerpt: 'Tidak seperti Android atau Windows yang sudah diatur oleh pabrikan, factory reset di Linux bisa diatur seperti apa kita mau saat kita melakukan factory reset. Kita bisa mengubah konfigurasi atau memasang software yang jika komputer kita kembalikan ke factory reset, konfigurasi atau software terse...',
    image: 'https://opensuse.id/wp-content/uploads/2020/07/snapper.png',
    category: 'panduan',
    date: '3 September 2020',
    slug: 'membuat-fitur-factory-reset'
  },
  {
    id: 30,
    title: 'Minimal/custom install openSUSE',
    excerpt: 'Minimal/custom install openSUSE bisa dilakukan dengan menggunakan ISO DVD Image atau Network Image. Tapi saya biasanya menggunakan DVD Image, supaya saat proses instalasi tidak harus terhubung ke internet yang membuat proses instalasi lebih cepat. Juga setelah proses instalasi selesai kita bisa l...',
    image: 'https://opensuse.id/wp-content/uploads/2020/08/kde-minimal.png',
    category: 'panduan',
    date: '23 Agustus 2020',
    slug: 'minimal-custom-install-opensuse'
  },
  {
    id: 31,
    ...
    category: 'panduan',
    date: '8 Agustus 2020',
    slug: 'tmp-dengan-tmpfs-di-opensuse-tumbleweed'
  },
  {
    id: 32,
    title: 'Membersihkan Snapshot yang tertinggal',
    excerpt: 'Pada dasarnya Snapshot yang dibuat oleh Snapper akan otomatis dihapus oleh snapper-cleanup.service jika sudah waktunya terhapus sesuai dengan konfigurasi yang ada di /etc/snapper/configs (atau dengan perintah su -c “snapper -c root get-config”). Namun adakalanya Snapper gagal menghapus satu atau ...',
    image: 'https://opensuse.id/wp-content/uploads/2020/07/snapper.png',
    category: 'panduan',
    date: '29 Juli 2020',
    slug: 'membersihkan-snapshot-yang-tertinggal'
  },
  {
    id: 33,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/07/fdm.png',
    category: 'panduan',
    date: '4 Juli 2020',
    slug: 'menjalankan-free-download-manager-di-opensuse'
  },
  {
    id: 34,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/07/container-5-2-salinan-.png',
    category: 'kegiatan',
    date: '2 Juli 2020',
    slug: 'pengumuman-rilis-opensuse-152'
  },
  {
    id: 35,
    title: 'openSUSE 15.2 akan segera rilis! Mau hadiah dari openSUSE-ID?',
    excerpt: 'Beberapa hari lagi openSUSE 15.2 akan segera rilis! Tulis ulasanmu di blog masing-masing dan dapatkan spesial “Mystery Box” dari openSUSE Indonesia, caranya gampang banget cukup buat tulisan mengenai openSUSE 15.2 seperti apa saja yang baru dan peningkatan apa dari versi sebelumnya. Lalu mention ...',
    image: 'https://opensuse.id/wp-content/uploads/2020/06/release-is-coming-black.png',
    category: 'kegiatan',
    date: '28 Juni 2020',
    slug: 'opensuse-15-2-akan-segera-rilis-mau-hadiah-dari-opensuse-id'
  },
  {
    id: 36,
    title: 'Call for Paper Gimpscape Artweek Telah Dibuka',
    excerpt: 'Gimpscape Artweek merupakan agenda komunitas Gimpscape Indonesia berupa sesi berbagi dalam bentuk lokakarya atau presentasi ringkas. Pada tahun ini, Gimpscape Artweek diselenggarakan secara daring dan terbuka untuk seluruh anggota komunitas Gimpscape Indonesia. Kegiatan ini diprakarsai oleh para ...',
    image: 'https://opensuse.id/wp-content/uploads/2020/06/poster_artweek_cfp.png',
    category: 'kegiatan',
    date: '6 Juni 2020',
    slug: 'call-for-paper-gimpscape-artweek-telah-dibuka'
  },
  {
    id: 37,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/05/collabora-office-1232x693.png',
    category: 'panduan',
    date: '21 Mei 2020',
    slug: 'memasang-collabora-office-snapshot-pada-opensuse-tumbleweed'
  },
  {
    id: 38,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/05/katalon-leap-1232x693.png',
    category: 'panduan',
    date: '19 Mei 2020',
    slug: 'memasang-katalon-studio-pada-opensuse-leap'
  },
  {
    id: 39,
    title: 'openSUSE Virtual Summit',
    excerpt: 'openSUSE akan mengadakan openSUSE Virtual Summit pada 1 Mei. Semua waktu pada jadwal adalah Waktu UTC. Acara akan akan berlangsung di opensuse.reqmagic.com. Anda dapat mendaftar di events.opensuse.org pada 30 April. Simak pembicara dari Indonesia, diantaranya Anak Agung Bagus Arya Wiradarma – IT ...',
    image: 'https://opensuse.id/wp-content/uploads/2020/04/virtlogo.png',
    category: 'kegiatan',
    date: '30 April 2020',
    slug: 'opensuse-virtual-summit'
  },
  {
    id: 40,
    title: 'NgabuburIT DevOps – Ngobrolin Otomasi',
    excerpt: 'Hai gaes! ada acara keren nih yang bisa kamu ikutin selama WFH dan nungguin waktu berbuka puasa! Yak, acara keren itu adalah ngabuburIT DevOps. Kita akan banyak berbincang bagaimana melakukan otomasi. Acara keren ini juga dipandu oleh pemateri yang sangat mumpuni dibidangnya yaitu Kak Benediktus ...',
    image: 'https://opensuse.id/wp-content/uploads/2020/04/rect2501-1232x1361.png',
    category: 'kegiatan',
    date: '25 April 2020',
    slug: 'ngabuburit-devops-ngobrolin-otomasi'
  },
  {
    id: 41,
    title: 'Pendaftaran Peserta KonPeTI Dibuka',
    ...
    category: 'kegiatan',
    date: '1 April 2020',
    slug: 'pendaftaran-peserta-konpeti-dibuka'
  },
  {
    id: 42,
    ...
    category: 'panduan',
    date: '29 Maret 2020',
    slug: 'memasang-cockpit-pada-opensuse-leap-15-1'
  },
  {
    id: 43,
    title: 'Konferensi Pekerja Teknologi Informasi (KonPeTI) — #GerakDariRumah',
    excerpt: 'Konferensi Pekerja Teknologi Informasi (KonPeTI) merupakan bagian dari kegiatan #GerakDariRumah. Kegiatan ini mempertemukan pengguna, pebisnis, pengembang, pelajar dan profesional Teknologi Informasi (TI) dari seluruh belahan dunia. Kegiatan ini dilaksanankan secara daring dengan format penyajian...',
    image: 'https://opensuse.id/wp-content/uploads/2020/03/poster-pup-update-4-1024x1024-1.png',
    category: 'kegiatan',
    date: '29 Maret 2020',
    slug: 'konferensi-pekerja-teknologi-informasi-konpeti-gerakdarirumah'
  },
  {
    id: 44,
    title: 'Sesi Berbagi: FLOSS & Creative Commons Dalam Pendidikan & Pekerjaan',
    excerpt: 'Halo semua!!!   Kali ini Komunitas openSUSE Indonesia dan Gimpscape ID ingin mengadakan sebuah sharing session nih.   Temanya : FOSS dalam dunia pendidikan dan Lisensi Creative Commons dalam dunia professional   Kamu pake FOSS di kampus/sekolah tapi gak pede?   Kalo pake FOSS ada manfaatnya gak s...',
    image: 'https://opensuse.id/wp-content/uploads/2020/03/posterkolab3.png',
    category: 'kegiatan',
    date: '7 Maret 2020',
    slug: 'sesi-berbagi-floss-creative-commons-dalam-pendidikan-pekerjaan'
  },
  {
    id: 45,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/02/energy-saving.png',
    category: 'panduan',
    date: '3 Februari 2020',
    slug: 'hibernate-ke-swap-file'
  },
  {
    id: 46,
    title: 'Kemeriahan #MozTalk – Open Source Day (openSUSE and Mozilla Firefox Edition)',
    excerpt: '19 Januari 2020, cuaca cukup cerah di bilangan Kuningan Barat, Jakarta. #MozTalk – Open Source Day (openSUSE and Mozilla Firefox Edition) dibuka oleh perwakilan dari Komunitas Mozilla Indonesia, lalu dilanjutkan oleh pembicara pertama dari Komunitas openSUSE Indonesia, yang diwakili oleh mas Kuku...',
    image: 'https://opensuse.id/wp-content/uploads/2020/01/moztalk-1232x924.jpg',
    category: 'kegiatan',
    date: '20 Januari 2020',
    slug: 'kemeriahan-moztalk-open-source-day-opensuse-and-mozilla-firefox-edition'
  },
  {
    id: 47,
    title: 'Pengumuman Pemenang #KuisLiburan2019',
    excerpt: 'Komunitas openSUSE Indonesia (openSUSE-ID) mengucapkan terima kasih atas antusiasme peserta pada #KuisLiburan2019 kali ini. Dari 127 jawaban yang masuk, kami harus mengkurasi jawaban yang salah maupun kurang tepat. Tersaring 42 jawaban yang tepat dan kami harus mengundi lagi untuk menentukan siap...',
    image: 'https://opensuse.id/wp-content/uploads/2020/01/photo_2020-01-11_14-54-51.jpg',
    category: 'komunitas',
    date: '11 Januari 2020',
    slug: 'pengumuman-pemenang-kuisliburan2019'
  },
  {
    id: 48,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/01/pgpool-II_logo_square_150x150.png',
    category: 'panduan',
    date: '10 Januari 2020',
    slug: 'high-availability-postgresql-cluster-dengan-pgpool-ii-bagian-ke-3'
  },
  {
    id: 49,
    title: '#MozTalk – Open Source Day (openSUSE and Mozilla Firefox Edition)',
    excerpt: 'Apakah kamu salah satu pengguna software open source yang ingin berkontribusi kembali ke proyeknya? Pada kesempatan MozTalk kali ini kami akan membahas tentang cara berkontribusi ke proyek open source seperti openSUSE dan Mozilla Firefox. Akan ada 2 pembicara pada acara ini: Kukuh Syafaat “Berken...',
    image: 'https://opensuse.id/wp-content/uploads/2020/01/ENvs85VU4AE6NuG.jpeg',
    category: 'kegiatan',
    date: '10 Januari 2020',
    slug: 'moztalk-open-source-day-opensuse-and-mozilla-firefox-edition'
  },
  {
    id: 50,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/01/opensuse-teh.jpg',
    category: 'panduan',
    date: '10 Januari 2020',
    slug: 'mencoba-podman-dan-buildah-di-opensuse-tumbleweed'
  },
  {
    id: 51,
    ...
    category: 'panduan',
    date: '9 Januari 2020',
    slug: 'high-availability-postgresql-cluster-dengan-pgpool-ii-bagian-ke-2'
  },
  {
    id: 52,
    ...
    category: 'panduan',
    date: '8 Januari 2020',
    slug: 'high-availability-postgresql-cluster-dengan-pgpool-ii-bagian-ke-1'
  },
  {
    id: 53,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2020/01/jd1-dashboard.png',
    category: 'panduan',
    date: '8 Januari 2020',
    slug: 'memasang-jdownloader-di-opensuse-leap-15-1'
  },
  {
    id: 54,
    ...
    category: 'panduan',
    date: '4 Januari 2020',
    slug: 'tuning-konfigurasi-postgresql'
  },
  {
    id: 55,
    title: '#KuisLiburan2019',
    excerpt: 'Dapatkan bingkisan tahun baru dari openSUSE-ID untuk 20 pemenang dan 1 SSD 120 GB untuk 1 orang yang beruntung 🙂   Pertanyaannya: 1. Pada tahun berapa dan di kota mana saja, openSUSE.Asia Summit pernah diadakan di Indonesia? 2. Apa nama hewan yang ada pada logo openSUSE? 3. Sebutkan 2 varian dist...',
    image: 'https://opensuse.id/wp-content/uploads/2019/12/kuis-liburan-2019-1232x1743.png',
    category: 'komunitas',
    date: '24 Desember 2019',
    slug: 'kuisliburan2019'
  },
  {
    id: 56,
    title: 'Repositori Bagi Pengguna openSUSE Tumbleweed',
    excerpt: 'Kabar baik bagi pengguna openSUSE Tumbleweed, Komunitas openSUSE Indonesia telah menyediakan mirror untuk repositori Tumbleweed. openSUSE Heroes Tim masih melakukan pengecekan apakah repositori ini layak untuk dimasukkan sebagai repositori resmi dan dapat mengakses ke stage.opensuse.org. Mudah-mu...',
    image: 'https://opensuse.id/wp-content/uploads/2019/11/tumbleweed.png',
    category: 'komunitas',
    date: '27 November 2019',
    slug: 'repositori-bagi-pengguna-opensuse-tumbleweed'
  },
  {
    id: 57,
    title: 'openSUSE-ID di Kopdar KDE Yogyakarta 2019',
    excerpt: 'Komunitas openSUSE Indonesia kali ini turut memeriahkan Kopdar yang diadakan KDE Indonesia, kali ini KDE Indonesia muncul kembali dengan mengadakan kopdar di Yogyakarta dengan mengangkat tema “Jadi Penerjemah itu Mudah”. Kopdar ini diadakan pada tanggal 23 November 2019 bertempat di Kantor Midtra...',
    image: 'https://opensuse.id/wp-content/uploads/2019/11/photo_2019-11-24_06-56-06-1232x924.jpg',
    category: 'kegiatan',
    date: '24 November 2019',
    slug: 'opensuse-id-di-kopdar-kde-yogyakarta-2019'
  },
  {
    id: 58,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2019/11/firefox-1232x719.png',
    category: 'panduan',
    date: '22 November 2019',
    slug: 'menyembunyikan-tab-toolbar-firefox'
  },
  {
    id: 59,
    ...
    image: 'https://opensuse.id/wp-content/uploads/2019/11/kubic-2.png',
    category: 'panduan',
    date: '5 November 2019',
    slug: 'opensuse-microos-dan-systemd-timer'
  },
  {
    id: 60,
    title: 'openSUSE-ID di Indonesia Open Infrastructure Day 2019',
    excerpt: 'Komunitas openSUSE Indonesia mendapat kehormatan untuk menghadiri Indonesia Open Infrastructure Day 2019 edisi pertama ini di kota pahlawan, Surabaya. Ajang ini juga sebagai sarana silaturahmi dan kopdar bersama teman-teman komunitas FOSS lainnya, seperti Kelompok Linux Arek Suroboyo (KLAS), Komu...',
    image: 'https://opensuse.id/wp-content/uploads/2019/11/CMfE9Jhw-1232x361.jpeg',
    category: 'kegiatan',
    date: '3 November 2019',
    slug: 'opensuse-id-di-indonesia-open-infrastructure-day-2019'
  },
  {
    id: 61,
    title: 'openSUSE-ID di GNOME.Asia Summit 2019',
    excerpt: 'Komunitas openSUSE Indonesia turut memeriahkan gelaran GNOME.Asia Summit 2019 di Gresik pada tanggal 11-13 Oktober 2019. Kebetulan openSUSE juga merupakan salah satu sponsor dalam acara ini. Booth openSUSE diwakili oleh Komunitas openSUSE Indonesia yang kali ini digawangi oleh Edwin Zakaria, Estu...',
    image: 'https://opensuse.id/wp-content/uploads/2019/11/IMG_20191012_145623-1232x924.jpg',
    category: 'kegiatan',
    date: '1 November 2019',
    slug: 'opensuse-id-di-gnome-asia-summit-2019'
  },
  {
    id: 62,
    title: 'Kemeriahan openSUSE.Asia Summit 2019',
    excerpt: 'Komunitas openSUSE Indonesia mengucapkan terima kasih kepada para peserta, pembicara, relawan, sponsor, panitia dan semua pihak yang telah membantu dan mendukung terselenggaranya openSUSE.Asia Summit 2019 ini. Mohon maaf apabila masih terdapat kekurangan disana-sini. Slide pembicara dapat diakses...',
    image: 'https://opensuse.id/wp-content/uploads/2019/11/P1030282-1232x693.jpg',
    category: 'kegiatan',
    date: '1 November 2019',
    slug: 'kemeriahan-opensuse-asia-summit-2019'
  },
  {
    id: 63,
  ...
  },
  {
    ...
    category: 'kegiatan',
    date: '17 Februari 2016',
    slug: 'opensuse-id-di-gnome-asia-summit-2015'
  },
];
