...
const BlogPost = () => {
  ...
  const blogPosts = {
    'cfp-opensuse-asia-summit-2026-dibuka': {
      ...
      <section>
          <p>Kamu juga bisa mengunjungi <a href="https://opensuse.id/konferensi/opensuse-asia-summit-2026" target="_blank">halaman khusus openSUSE Asia Summit 2026.</p>
